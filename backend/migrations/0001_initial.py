# Generated by Django 4.1.2 on 2023-05-10 16:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator(message='Номер телефона в формате +7xxxxxxxxxxx', regex='^7\\d{10}$')], verbose_name='Номер телефона клиента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.distribution', verbose_name='Рассылка')),
            ],
        ),
    ]
